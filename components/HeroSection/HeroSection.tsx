          ...
          <div className='flex flex-col-reverse gap-8 md:flex-row md:justify-between'>
            <div className='space-y-4 md:max-w-lg'>
              ...
              <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
                Hi, I am <span className="text-primary">Pasquale Favella</span>
                </h1>
              ...
              I am a highly skilled and experienced professional with a passion for creating high-quality web and mobile applications. 
              <br/>
