...
- ${f.default.get_years_of_experience()}+ years in software development
...
CONTACT INFOS:
- GitHub: ${f.default.git_url}
- LinkedIn: ${f.default.linkedin_url}
- Email: ${f.default.contact_mail}
...
`;var h=e.i(97794),v=e.i(29698),b=e.i(10941),T=e.i(55613),x=e.i(66874);e.s([],58994),e.i(58994),e.s(["default",0,()=>{let{messages:d,status:f,isBotLoadingResponse:w,sendMessage:y,supportsTransformerJs:N,error:P,regenerate:E}=function(){let t=(0,l.useMemo)(()=>(0,u.doesBrowserSupportTransformersJS)(),[]),r=(0,l.useMemo)(()=>t?new m((0,u.transformersJS)("onnx-community/granite-4.0-350m-ONNX-web",{device:"webgpu",dtype:"fp16",worker:e.r(19803)(Worker,{type:"module"})}),{systemPrompt:g}):null,[t]),{error:n,status:o,messages:a,setMessages:s,sendMessage:i,stop:d,regenerate:f}=(0,c.useChat)({transport:r,onError(e){p.default.error(e.message)},experimental_throttle:50,id:"chatbot-pakybot"});return{supportsTransformerJs:t,error:n,status:o,messages:a,setMessages:s,isBotLoadingResponse:"submitted"===o||"streaming"===o,sendMessage:e=>{i({text:e})},stop:d,regenerate:f}}(),S=w||!!P;return N?(0,t.jsxs)(h.Popover,{children:[(0,t.jsx)(h.PopoverTrigger,{asChild:!0,className:"fixed bottom-4 right-1 sm:bottom-10 sm:right-6 z-50",children:(0,t.jsx)("div",{className:"tooltip tooltip-left before:text-xs before:content-[attr(data-tip)]","data-tip":"ask a question",children:(0,t.jsx)("button",{className:"btn btn-ghost btn-circle ",children:(0,t.jsx)(r.BsFillChatQuoteFill,{size:40})})})}),(0,t.jsx)(h.PopoverContent,{className:"w-96",children:(0,t.jsxs)("div",{className:"grid gap-4",children:[(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsx)("h4",{className:"font-medium leading-none",children:"Pakybot"}),(0,t.jsx)("p",{className:"text-sm text-base-content",children:"Ask some question about me"})]}),(0,t.jsxs)(x.Conversation,{className:"h-[200px] no-scrollbar",children:[(0,t.jsxs)(x.ConversationContent,{children:[0===d.length&&(0,t.jsxs)("div",{className:(0,i.cn)("chat chat-start"),children:[(0,t.jsx)("div",{className:"chat-image avatar",children:(0,t.jsx)(o.RiRobot2Line,{size:30})}),(0,t.jsx)("div",{className:"chat-bubble bg-base-300 text-base-content",children:"Ask me something!"})]}),d.map(e=>{let r="assistant"===e.role||"system"===e.role,n=r?o.RiRobot2Line:o.RiUser3Fill;return(0,t.jsxs)("div",{className:(0,i.cn)("chat",r?"chat-start":"chat-end"),children:[(0,t.jsx)("div",{className:"chat-image avatar",children:(0,t.jsx)(n,{size:30})}),(0,t.jsxs)("div",{className:"chat-bubble bg-base-300 text-base-content",children:[e.parts.filter(e=>"data-modelDownloadProgress"===e.type).map((e,r)=>e.data.message&&"ready"!==f?(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center gap-1 mb-1",children:[(0,t.jsx)(b.Loader,{className:"size-3"}),(0,t.jsx)("span",{className:"text-xs",children:e.data.message})]}),"downloading"===e.data.status&&void 0!==e.data.progress&&(0,t.jsx)(T.Progress,{value:e.data.progress})]},r):null),e.parts.filter(e=>"text"===e.type).map((e,r)=>(0,t.jsx)(v.Response,{responseText:e.text,className:"text-sm "},r)),"user"===e.role&&0===e.parts.filter(e=>"text"===e.type).length&&(0,t.jsx)(t.Fragment,{children:e.content})]})]},e.id)}),"submitted"===f&&(0,t.jsxs)("div",{className:(0,i.cn)("chat chat-start"),children:[(0,t.jsx)("div",{className:"chat-image avatar",children:(0,t.jsx)(o.RiRobot2Line,{size:30})}),(0,t.jsx)("div",{className:"chat-bubble bg-base-300 text-base-content",children:(0,t.jsx)(a.TbWriting,{size:20,className:"animate-bounce"})})]}),P&&(0,t.jsxs)("div",{className:(0,i.cn)("chat chat-start"),children:[(0,t.jsx)("div",{className:"chat-image avatar",children:(0,t.jsx)(o.RiRobot2Line,{size:30})}),(0,t.jsxs)("div",{className:"chat-bubble chat-bubble-error",children:[(0,t.jsx)("p",{className:"text-sm",children:"Something went wrong."}),(0,t.jsxs)("button",{type:"button",className:"btn btn-ghost btn-xs mt-1 gap-1",onClick:()=>E(),children:[(0,t.jsx)(s.MdRefresh,{size:14}),"Retry"]})]})]})]}),(0,t.jsx)(x.ConversationScrollButton,{className:"btn-sm animate-bounce"})]}),(0,t.jsxs)("form",{className:"flex items-center justify-center w-full space-x-2",onSubmit:e=>{e.preventDefault();let t=new FormData(e.currentTarget).get("message");t.trim()&&(e.currentTarget.reset(),y(t))},children:[(0,t.jsx)("input",{type:"text",name:"message",placeholder:"Type your question",required:!0,autoComplete:"off",className:"input input-bordered w-full max-w-xs",disabled:S}),(0,t.jsx)("button",{className:"btn btn-neutral btn-square",type:"submit",disabled:S,children:(0,t.jsx)(n.IoSendSharp,{})})]})]})})]}):null}],85901)},66897,e=>{e.n(e.i(85901))}]);